  ...
  $(window).width() > 767 &&
    ...
    $(".list-button .button-circle").on("click", function (t) {
      ...
      if (
        ...
        let t = $(window).width() / 2;
        (t = t > 600 && $(window).width() > 767 ? 600 : $(window).width()),
          ...
          gsap.fromTo(
            `section.product-detail${i} .wrapper-content`,
            { width: 0, x: "100%" },
            { width: t, x: 0, duration: 1, ease: "none" }
          );
      }
    });
...
function animateZoomIn() {
  ...
  const t = $(window).width() < 767 ? "-100" : "-150";
  $(".animate-zoomin").each(function () {
    ...
    gsap.fromTo(
      ...
      e.on("click", function () {
        gsap.to(window, {
          scrollTo: {
            y: e.offset().top - (window.innerHeight - e.outerHeight()),
            autoKill: !1
          },
          duration: 1,
          ease: "power2.out"
    ...
    $(".animate-zoomin").each(function () {
      ...
      gsap.fromTo(
        $(this).find(".wrapper-image .img"),
        { scale: "2", transformOrigin: "top center", y: -150 },
        {
          scrollTrigger: {
            trigger: this,
            start: "top 103%",
