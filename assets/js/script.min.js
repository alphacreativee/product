      ...
      t.length &&
        (t.forEach((e) => {
          e.addEventListener("click", (o) => {
            ...
            if (!n || !n.startsWith("#") || !document.querySelector(n)) return;
            o.preventDefault(),
              t.forEach((t) => t.classList.remove("active")),
              e.classList.add("active");
            const i = $(window).width() < 767 && "#discover" === n ? 80 : 0;
            gsap.to(window, {
              duration: 0.5,
              scrollTo: { y: n, offsetY: i },
              ease: "power2.out"
            });
          });
        }),
  ...
  t.length &&
    t.forEach((t) => {
      new Swiper(t, {
        ...
        effect: "creative",
        creativeEffect: {
          prev: { translate: ["-120%", 0, -700] },
          next: { translate: ["120%", 0, -700] }
        },
        loop: "true",
